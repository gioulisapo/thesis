...
Neurons             :Sigmoid
Loss functions      :Quadradic Loss function
W initialization    :Random, Gaussian mean=0, variance=1
        ...
        for j in xrange(epochs):
            ...
            if test_data:
                if j==epochs-1:
                    ...
                    print "_Epoch {0}: {1} / {2}_\t\t".format(j+1, self.evaluate(test_data), n_test)
            else:
