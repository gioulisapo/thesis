...
if init=='default':
	print '\t* Weights: Random, (Gaussian mean=0, variance=1)/sqrt(Number_Of_Neuron_Connection_Inputs)'
	print '\t* Biases: Random, Gaussian mean=0, variance=1'
else:
	print '\t* Weights: Random, Gaussian mean=0, variance=1'
	print '\t* Biases: Random, Gaussian mean=0, variance=1'
