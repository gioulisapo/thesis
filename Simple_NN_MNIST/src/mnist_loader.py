...
def load_data_wrapper():
    ...
    training_inputs = [np.reshape(x, (784, 1)) for x in tr_d[0]] # returns a list of the images
    training_results = [vectorized_result(y) for y in tr_d[1]] # list of numpy.ndarrays (All labels of the training data)
