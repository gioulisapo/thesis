...
from network import FullyConnectedLayer, SoftmaxLayer
import time
...
def mlp(training_data ,validation_data ,test_data, Input_Neurons, Neurons=sigmoid, n=1, epochs=5, mini_batch_size=20,lmbda=0.1, Learning_Rate=5):
    '''
        ...
        are given to the user as function arguments. Layer combinations must have the two following characteristics
        ...
        Known Issues:
            cifar_10 networks don't seem to improve their performance
    '''
